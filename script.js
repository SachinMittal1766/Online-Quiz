...
const exit_btn = Rulesbox.querySelector(".buttons .quit");
const continue_btn = Rulesbox.querySelector(".buttons .restart");
...
start_btn.onclick = ()=>{
    Rulesbox.classList.add("activerule"); 
}

exit_btn.onclick = ()=>{
    Rulesbox.classList.remove("activerule"); 
}
...
let questions = [
    ...
    answer: "Bitcoin",
    options: [
      "Block Transfer Chain",
      "Bitcoin",
      "Bitcoin Transfer Channel",
      "Block Transition Channel"
    ]
  },
    {
    numb: 5,
    ...
    options: [
      ...
      "Approaches to Programming Interface",
